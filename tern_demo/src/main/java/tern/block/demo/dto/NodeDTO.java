...
public class NodeDTO implements Serializable{
	...
	@NotNull(message = "节点名称不能为空")
	 ...
	 @NotNull(message = "重复注册密码不能为空")
	 private String nodePasswordVaild;
	...
	public NodeDTO(String nodeName, String nodeSex, String nodePassword, String nodeEmail, String nodeTelphone) {
		super();
	...
	public NodeDTO(Integer nodeId, String nodeName, String nodeSex, String nodePassword, String nodeEmail,
	...
	public NodeDTO(String nodeName, String nodeSex, String nodePassword, String nodePasswordVaild, String nodeEmail,
			String nodeTelphone, Date nodeRegistryTime, String nodePubKey, String nodePriKey, Integer nodeCompetence,
			Integer nodeState, Integer nodeBlockNum) {
		super();
		this.nodeName = nodeName;
		this.nodeSex = nodeSex;
		this.nodePassword = nodePassword;
		this.nodePasswordVaild = nodePasswordVaild;
		this.nodeEmail = nodeEmail;
		this.nodeTelphone = nodeTelphone;
		this.nodeRegistryTime = nodeRegistryTime;
		this.nodePubKey = nodePubKey;
	...
	public String getNodePasswordVaild() {
		return nodePasswordVaild;
	}

	public void setNodePasswordVaild(String nodePasswordVaild) {
		this.nodePasswordVaild = nodePasswordVaild;
	}
